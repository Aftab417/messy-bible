          ...
          <div className="w-full md:w-7/12 bg-[#F9F9F9] rounded-[30px] md:p-24">
            ...
            >
              <div className="w-full pb-4 mt-3">
                <div className="flex items-center gap-2 rounded-[10px] border-[0.5px] border-[#AFAFAF] bg-[#FFF] px-6 py-3 dark:border-gray-600 dark:bg-gray-900">
              ...
              <div className="w-full pb-2">
                <div className="flex items-center gap-2 relative rounded-[10px] border-[0.5px] border-[#AFAFAF] bg-[#F6F6F6] dark:border-gray-600 dark:bg-gray-900 px-6 py-3 mt-3">
                  {/* Left Icon */}
                  ...
                  <input
                    ...
                    className="w-full bg-transparent focus:outline-none text-base pr-10"
                  />
