    ...
    <>
      <div className="lg:flex justify-between">
        ...
        onChange={(e) => {
          ...
          <button onClick={handleExport} className="bg-[#FA8059] cursor-pointer hover:bg-[#f96c42] text-white text-sm font-semibold px-[18px] w-full sm:w-[150px] py-[14px] rounded-[12px] transition mt-[10px] sm:mt-[0px]">
            Export Data
          </button> 
        </div>
      </div>
        ...
        <table className="min-w-[700px] w-full overflow-hidden shadow border-separate border-spacing-x-4">
          <thead className="text-[#794A3A] font-dm-sans text-[14px] font-semibold ">
            <tr>
              ...
              <th className="p-[5px] border-b border-[#505050] text-center w-fit">User Name</th>
              <th className="p-[5px] border-b border-[#505050] text-center w-fit">Email</th>
              <th className="p-[5px] border-b border-[#505050] text-center w-fit">Current Plan</th>
            ...
            {users.length === 0 ? (
              ...
              paginatedUsers.map((user, i) => (
                <tr key={user._id} className="border-b border-[#DEE2E6]/50 ">
                  ...
                  <td className="p-[5px] text-center border-b-1 border-[#F9F9F9] text-[#5B5B5B]">{user.username}</td>
                  <td className="p-[5px] text-center border-b-1 border-[#F9F9F9] text-[#5B5B5B]">{user.email}</td>
                  <td className="p-[5px] text-center border-b-1 border-[#F9F9F9] text-[#5B5B5B]">{user.CurrentPlan}</td>
