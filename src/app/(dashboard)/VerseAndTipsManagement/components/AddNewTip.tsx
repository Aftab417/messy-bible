...
const AddNewTip = ({ onClose }: AddNewTipProps) => {
      ...
      >
        ...
        <div className="flex flex-col gap-2">
          ...
          <textarea
            ...
            className={`border text-[#656565] scrollbar-hide rounded-lg px-4 py-3 text-base min-h-[80px] resize-none focus:outline-none bg-white focus:ring-2 focus:ring-[#F6805C] ${formik.touched.tip && formik.errors.tip ? "border-red-400" : "border-[#AFAFAF]"}`}
